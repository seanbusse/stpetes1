...
<head>
 ...
 <button onclick="window.open('http://www.facebook.com/sharer.php?u=https:/<?php echo $_SERVER[HTTPS_HOST]; ?><?php echo $_SERVER[REQUEST_URI]; ?>.php','Facebook','width=600,height=300,left='+(screen.availWidth/2-300)+',top='+(screen.availHeight/2-150)+''); return false;" href="http://www.facebook.com/sharer.php?u=https:/<?php echo $_SERVER[HTTPS_HOST]; ?><?php echo $_SERVER[REQUEST_URI]; ?>">Click to Share</button>
